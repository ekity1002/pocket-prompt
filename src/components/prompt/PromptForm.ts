...
export function createPromptForm(props: PromptFormProps): HTMLElement {
  ...
  submitButton.className = 'px-4 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500';
...
function createFormGroup(props: FormGroupProps): HTMLElement {
  ...
  if (props.input) {
    ...
    input.className = 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500';
  ...
  if (props.textarea) {
    ...
    textarea.className = 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-vertical';
...
function createTagsField(props: TagsFieldProps): HTMLElement {
  ...
  function renderTags() {
    ...
    props.tags.forEach((tag, index) => {
      ...
      tagElement.className = 'inline-flex items-center px-3 py-1 text-sm font-medium bg-blue-100 text-blue-800 rounded-full';
  ...
  tagInput.type = 'text';
  tagInput.className = 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500';
