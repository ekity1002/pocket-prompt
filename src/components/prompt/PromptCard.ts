...
export function createPromptCard(props: PromptCardProps): HTMLElement {
  ...
  if (props.onToggleFavorite) {
    ...
    favoriteButton.className = 'flex-shrink-0 p-1 text-gray-400 hover:text-yellow-500 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded';
  ...
  if (!props.compact) {
    ...
    content.textContent = props.prompt.content.length > 150 
  ...
  if (props.showActions !== false) {
    ...
    if (props.onUse) {
      ...
      useButton.className = 'px-3 py-1.5 text-xs font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500';
    ...
    if (props.onCopy) {
      ...
      copyButton.className = 'px-3 py-1.5 text-xs font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500';
    ...
    if (props.onEdit) {
      ...
      editButton.className = 'p-1.5 text-gray-400 hover:text-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500';
    ...
    if (props.onDelete) {
      ...
      deleteButton.className = 'p-1.5 text-gray-400 hover:text-red-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500';
...
function getCardClasses(props: PromptCardProps): string {
  const baseClasses = 'bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200';
