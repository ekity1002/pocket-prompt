  ...
  if (props.title || props.closable !== false) {
    ...
    if (props.closable !== false) {
      ...
      closeButton.className =
        'text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg p-1';
...
function getModalClasses(props: ModalProps): string {
  const baseClasses =
    'relative bg-white rounded-lg shadow-xl transform transition-all max-w-full max-h-full';
